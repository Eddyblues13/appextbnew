            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="login-form-wrap" style="background: #fff; padding: 40px; border-radius: 10px; box-shadow: 0 0 15px rgba(0,0,0,0.1);">
                        ...
                        <form class="login-form" action="{{ route('user.register') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3 position-relative">
                                        ...
                                        <input type="password" name="password" id="reg-password" class="form-control" required placeholder="Enter Password" style="padding-right: 40px;">
                                        <span toggle="#reg-password" class="toggle-password" style="position: absolute; right: 15px; top: 38px; cursor: pointer; color: #666; font-size: 18px;">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3 position-relative">
                                        ...
                                        <input type="password" name="password_confirmation" id="reg-password-confirm" class="form-control" required placeholder="Confirm Password" style="padding-right: 40px;">
                                        <span toggle="#reg-password-confirm" class="toggle-password" style="position: absolute; right: 15px; top: 38px; cursor: pointer; color: #666; font-size: 18px;">
                                            <i class="ri-eye-off-line"></i>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 text-center mt-3">
                                    <p class="mb-0">Already have an account? <a href="{{ route('login') }}" class="link style1" style="color: #3037ff; font-weight: 600;">Login</a></p>
                                </div>
                            </div>
                        </form>
                    </div>
